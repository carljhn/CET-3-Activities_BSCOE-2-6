...
export class Background {
    constructor(game){
        ...
        this.layer2 = new Layer(this.game, this.width, this.height, 0.1, this.layerImage2);
        this.layer3 = new Layer(this.game, this.width, this.height, 0.2, this.layerImage3);
        this.layer4 = new Layer(this.game, this.width, this.height, 0.3, this.layerImage4);
        this.layer5 = new Layer(this.game, this.width, this.height, 0.4, this.layerImage5);
