...
export class Background {
    constructor(game){
        ...
        this.layer2 = new Layer(this.game, this.width, this.height, 0.3, this.layerImage2);
        this.layer3 = new Layer(this.game, this.width, this.height, 0.8, this.layerImage3);
